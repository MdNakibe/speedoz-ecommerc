   ...
   <div class="header">
        ...
        <ul class="nav user-menu">
          ...
          <li class="nav-item dropdown has-arrow main-drop">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
              <span class="user-img"><img src="/assets/img/profile.jpg" alt="" /> <span class="status online"></span></span>
            </a>
              ...
              <div class="profilename">
                <div class="profileset">
                  ...
                  <div class="profilesets">
                    <h6>{{ this.$store.getters['user/GET_AUTH_INFO'].name }}</h6>
                    <!-- <h5>Admin</h5> -->
                  </div>
                </div>
                <hr class="m-0" />
                ...
                <hr class="m-0" />
                <button class="dropdown-item logout pb-0" type="submit" @click="logout"><img src="/assets/img/icons/log-out.svg" class="me-2" alt="img" />Logout</button>
        ...
        <div class="dropdown mobile-user-menu">
          ...
          <div class="dropdown-menu dropdown-menu-right">
            ...
            <button class="dropdown-item" type="submit" @click="logout">Logout</button>
