              ...
              <div class="modal-body row">
                <div class="col-lg-12 col-sm-12 col-12">
                  <div class="form-group">
                    ...
                    <input type="text" v-model="sliderData.name" />
                  </div>
                </div>
                <div class="col-lg-12 col-sm-12 col-12">
                  <div class="form-group">
...
export default {
  ...
  computed: {
    filteredCategory() {
      const category = this.$store.getters['category/brands'];
            if (this.searchTerm === '') {
                return category;
            }else{
  ...
  methods:{
    ...
    previewImage: function(event) {
      ...
      if (input.files) {
        ...
        async saveCategory() {
            let data = {
                brand: this.sliderData,
                image: this.image,
            }
		    let isSuccess = await this.$store.dispatch('category/saveBrand', data);
            if(isSuccess) {
                this.sliderData.name= '';
        ...
        editCategory(item){
            ...
            this.sliderData.name= item.name;
        ...
        async catagoryDelete(id){
            ...
            await this.$store.dispatch('category/brandDelete', data);
        }
    },
};
</script>
