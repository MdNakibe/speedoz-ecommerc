      ...
      <div class="page-header">
        ...
        <div class="page-btn">
          <button
            ...
            @click="dialog = true"
          >
            <img src="/assets/img/icons/plus.svg" alt="img" class="me-1" />Add New Sub Category
          </button>
        </div>
        <v-dialog
        v-model="dialog"
              ...
              <div class="modal-body row">
                <div class="col-lg-12 col-sm-12 col-12">
                  <div class="form-group">
                    ...
                    <model-list-select 
                          :list="$store.getters['category/categories']" 
                          option-value="id" option-text="name" 
                          :placeholder="$store.getters['category/categories'].length > 0 ? 'Select Parent Category' : 'No data found'"
...
export default {
  ...
  computed: {
    filteredCategory() {
      const category = this.$store.getters['category/subcategories'];
            if (this.searchTerm === '') {
                return category;
            }else{
